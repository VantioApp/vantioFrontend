...
import { Users, Search, Mail, Calendar, Award, TrendingUp, ChevronDown, ChevronRight, GraduationCap, Eye } from 'lucide-react';
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-slate-200 bg-slate-50">
                  <th scope="col" className="py-3 px-6 text-xs font-semibold text-slate-500 uppercase tracking-wider">Nombre</th>
                  <th scope="col" className="py-3 px-6 text-xs font-semibold text-slate-500 uppercase tracking-wider">Email</th>
                  <th scope="col" className="py-3 px-6 text-xs font-semibold text-slate-500 uppercase tracking-wider">Fecha de Registro</th>
                  <th scope="col" className="py-3 px-6 text-xs font-semibold text-slate-500 uppercase tracking-wider">Total Pruebas</th>
                  <th scope="col" className="py-3 px-6 text-xs font-semibold text-slate-500 uppercase tracking-wider">Puntaje Promedio</th>
                  <th scope="col" className="py-3 px-6 text-xs font-semibold text-slate-500 uppercase tracking-wider">Areas Inscritas</th>
                  <th scope="col" className="py-3 px-6 text-xs font-semibold text-slate-500 uppercase tracking-wider">Rol</th>
                  <th scope="col" className="py-3 px-6 text-xs font-semibold text-slate-500 uppercase tracking-wider">Estado</th>
                  <th scope="col" className="py-3 px-6 text-xs font-semibold text-slate-500 uppercase tracking-wider text-right">Acción</th>
                </tr>
              </thead>
